...
- [ ] Explain the difference between `Relational Databases` and `SQL`.
    ...
    Relational Databases use tables to store information and make it easy to search for specific info.
    SQL is the language used to interact with the database and add, remove, or find data from the database.

- [ ] Why do tables need a `primary key`?

    They need a way to identify specific sets of data in the table that is internally generated by the database.
